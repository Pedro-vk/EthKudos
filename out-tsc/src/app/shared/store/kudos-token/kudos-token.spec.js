...
var kudos_token_reducers_1 = require("./kudos-token.reducers");
var fromKudosToken = require("./kudos-token.reducers");
var kudosTokenActions = require("./kudos-token.actions");
var kudos_token_effects_1 = require("./kudos-token.effects");
...
describe('KudosToken - Reducers', function () {
    it('should be auto-initialized', function () {
        var finalState = testing_utils_1.reduceActions(kudos_token_reducers_1.kudosTokenReducer);
        expect(finalState).not.toBeUndefined();
    });
    it('should set loading state', function () {
        var _a, _b, _c, _d, _e, _f;
        var steps = testing_utils_1.reduceActions(kudos_token_reducers_1.kudosTokenReducer, [
        ...
        var kudosTokens = steps.map(fromKudosToken.getKudosTokensById);
        expect(kudosTokens).toEqual([
            ...
            (_d = {}, _d[newAccount(1)] = { loading: false, loaded: { basic: true, total: true } }, _d),
            (_e = {}, _e[newAccount(1)] = { loading: false, loaded: { basic: true, total: true } }, _e[newAccount(2)] = { loading: true, loaded: {} }, _e),
            (_f = {}, _f[newAccount(1)] = { loading: false, loaded: { basic: true, total: true } }, _f[newAccount(2)] = { loading: false, loaded: { basic: true } }, _f),
        ]);
    });
    it('should set the data of a KudosToken', function () {
        var _a, _b, _c, _d;
        var steps = testing_utils_1.reduceActions(kudos_token_reducers_1.kudosTokenReducer, [
            new kudosTokenActions.LoadBasicDataAction(newAccount(1)),
        ...
        expect(kudosTokens).toEqual([
            ...
            (_d = {}, _d[newAccount(1)] = { loading: false, loaded: { basic: true, total: true }, name: 'test', isActivePoll: true }, _d),
        ]);
    });
    it('should set the balance of a member', function () {
        ...
        var steps = testing_utils_1.reduceActions(kudos_token_reducers_1.kudosTokenReducer, [
            new kudosTokenActions.LoadBasicDataAction(newAccount(1)),
            new kudosTokenActions.SetTokenDataAction(newAccount(1), 'basic', { name: 'test' }),
            new kudosTokenActions.SetBalanceAction(newAccount(1), newAccount(11), 9 * Math.pow(10, 17)),
        ], true);
        var kudosTokens = steps.map(fromKudosToken.getKudosTokensById);
        expect(kudosTokens).toEqual([
            {},
...
describe('KudosToken - Effects', function () {
    var store;
    var effects;
    var actions;
    beforeEach(function () {
        testing_1.TestBed.configureTestingModule({
            ...
            providers: __1.PROVIDERS.concat([
                kudos_token_effects_1.KudosTokenEffects,
                testing_2.provideMockActions(function () { return actions; }),
            ]),
        });
        effects = testing_1.TestBed.get(kudos_token_effects_1.KudosTokenEffects);
        store = testing_1.TestBed.get(store_1.Store);
    });
    it('should get basic KudosToken data', function () {
    ...
    it('should get total KudosToken data', function () {
        var setDataSpy = spyOn(effects, 'setData').and.returnValue(Observable_1.Observable.of({ type: 'mock' }));
        actions = jasmine_marbles_1.hot('-a', {
    ...
    it('should get data', function (done) {
        ...
        var getKudosTokenServiceAtSpy = spyOn(effects.kudosTokenFactoryService, 'getKudosTokenServiceAt')
            .and.returnValue({ onIsValid: Observable_1.Observable.of(true) });
    ...
    it('should update the data of a KudosToken when has changes', function () {
        var account1WatchStep = 0;
        var account1Changes = jasmine_marbles_1.hot('---c--------c', { c: newAccount(1) })
            .do(function () { return store.dispatch(new kudosTokenActions.SetTokenDataAction(newAccount(1), account1WatchStep++ ? 'total' : 'basic', {})); });
        var account2Changes = jasmine_marbles_1.hot('-------c', { c: newAccount(2) })
            .do(function () { return store.dispatch(new kudosTokenActions.SetTokenDataAction(newAccount(2), 'basic', {})); });
        ...
        var expected = jasmine_marbles_1.cold('---a---x----(ab)', {
...
//# sourceMappingURL=kudos-token.spec.js.map