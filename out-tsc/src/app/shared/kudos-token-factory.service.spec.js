...
describe('KudosTokenFactoryService', function () {
    beforeEach(function () {
    ...
    it('should be created', testing_1.inject([kudos_token_factory_service_1.KudosTokenFactoryService], function (service) {
        expect(service).toBeTruthy();
    }));
});
//# sourceMappingURL=kudos-token-factory.service.spec.js.map